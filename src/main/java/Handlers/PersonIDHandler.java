...
/**
 * A class to handle the http exchange for the personID api call.
 */
public class PersonIDHandler extends BaseHandler {

    /**
     * Handle the personID api call.
     *
        ...
        try {
            if (exchange.getRequestMethod().toLowerCase().equals("get")) {
                ...
                if (reqHeaders.containsKey("Authorization")) {
                    ...
                    PersonIDResult result = service.findPersonById(personID, authtoken);
