...
public class EventDAOTest {
    ...
    @Test
    public void findAllEventsForUserPass() throws DataAccessException {
        eDao.insert(bestEvent);
        List<Event> listOfEvents = eDao.findAllEventsForUser("Gale");
        assertEquals(1, listOfEvents.size());
    }

    @Test
    public void findAllEventsForUserFail() throws DataAccessException {
        eDao.insert(bestEvent);
        assertThrows(DataAccessException.class, () -> eDao.findAllEventsForUser("Testusername"));
    }
}
